...
; the image left-to-right, then move downward to the next row, filling rows top-to-bottom until every pixel of the image is filled.
;
...
(map ( partial get-pixel (partition 4 "0222112222120000")) (range 4))
;=> (\0 \1 \1 \0)

(partition 25 (map (partial get-pixel (partition 150 (slurp "resources/day8_input"))) (range 150)))
